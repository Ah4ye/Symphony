...
//     */
// pour ma fonction toolbar ProduitController ->recherche
    public function rechercherProduit(string $searchQuery): array
    {
        $qb = $this->createQueryBuilder('p');

        $qb->where($qb->expr()->like('p.denomination', ':searchQuery'))
